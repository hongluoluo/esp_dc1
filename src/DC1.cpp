...
void DC1::httpHtml(ESP8266WebServer *server)
{
    ...
    server->sendContent_P(
        PSTR("</td></tr></tbody></table>"
             ...
             "<div style='text-align:left'>"
             "<button type='button' id='sd0' onclick=\"sdayToggle(0)\" style='width:25px;height:25px;border-radius:12px;border:none;background:#eee;color:#888;font-size:11px;margin-right:4px;padding:0;text-align:center;line-height:25px'>一</button>"
             "<button type='button' id='sd1' onclick=\"sdayToggle(1)\" style='width:25px;height:25px;border-radius:12px;border:none;background:#eee;color:#888;font-size:11px;margin-right:4px;padding:0;text-align:center;line-height:25px'>二</button>"
             "<button type='button' id='sd2' onclick=\"sdayToggle(2)\" style='width:25px;height:25px;border-radius:12px;border:none;background:#eee;color:#888;font-size:11px;margin-right:4px;padding:0;text-align:center;line-height:25px'>三</button>"
             "<button type='button' id='sd3' onclick=\"sdayToggle(3)\" style='width:25px;height:25px;border-radius:12px;border:none;background:#eee;color:#888;font-size:11px;margin-right:4px;padding:0;text-align:center;line-height:25px'>四</button>"
             "<button type='button' id='sd4' onclick=\"sdayToggle(4)\" style='width:25px;height:25px;border-radius:12px;border:none;background:#eee;color:#888;font-size:11px;margin-right:4px;padding:0;text-align:center;line-height:25px'>五</button>"
